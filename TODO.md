...
- the documentation catches up: the README splits into a `docs/` directory, and a report
  reading guide teaches every report surface from a live worked example
...
[111]: #docs-split-the-readme-into-a-docs-directory
[112]: #docs-the-report-reading-guide
